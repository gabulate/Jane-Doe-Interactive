...
namespace Web.Utils
{
    public class Log
    {
        ...
        public static void Error(Exception exception, MethodBase methodBase)
        {
            string dummy = "";
        ...
        public static void Error(Exception exception, MethodBase methodBase, ref string pMensaje)
        {
